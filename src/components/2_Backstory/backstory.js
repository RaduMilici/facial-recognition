        ...
        <LeftContainer>
          <div className="description">
            ...
            <ul>
              ...
              <li>
                Mostly used for security purposes, though there is increasing interest in other
                areas.
              </li>
              ...
              <li>
                Face images can be captured from a distance and can be analyzed without ever
                requiring any interaction with the user/person.
              </li>
